...
// Package rid implements the ResourceIdenifier format specified at https://github.com/palantir/resource-identifier.
//
...
func ParseString(s string) (ResourceIdentifier, error) {
