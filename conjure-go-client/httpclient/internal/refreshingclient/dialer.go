...
func NewRefreshableDialer(ctx context.Context, p refreshable.Refreshable[DialerParams]) ContextDialer {
	out, _ := refreshable.Map(p, func(p DialerParams) ContextDialer {
